...
export default function Navbar() {
  ...
  <div className="navbar">
    ...
    <div className="navbar-list">
      <a type="button" className='text-secondary' href="#">貓貓商品</a>
      <a type='button' className='text-secondary' href>狗狗商品</a>
      <a type='button' className='text-secondary' href>部落格專區</a>
      <a  type='button' className='text-secondary' href>萌寵聚會</a>
      <a  type='button' className='text-secondary' href>寵物溝通</a>
    </div>
