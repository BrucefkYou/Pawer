...
import style from '@/components/product/category/categoryTag/other/categoryTagCatOther.module.scss';
import { BsPlusLg, BsDashLg } from 'react-icons/bs';
import ProductList from '@/components/product/list/productList';

const CategoryTagCatOther = ({ activeIndex, onActiveChange, setUrl }) => {
...
export default CategoryTagCatOther;
