                    ...
                    <div className="row content-1">
                        <div className="col-12 col-md-4 d-flex justify-content-center align-items-center">
                            <div className="avatar d-flex justify-content-center align-items-center">
                                {mydata.Img ? (<>
                                    <Image alt='avatar' src={`http://localhost:3005/pet/${mydata.Img}`} width={200} height={200} style={{ borderRadius: '50%', objectFit: 'cover' }} priority />
                                </>) : (<>
                                    <Image alt='avatar' src={`http://localhost:3005/pet/avatar-default.png`} width={200} height={200} style={{ borderRadius: '50%', objectFit: 'cover' }} priority />
                                </>)}
                            </div>
                        </div>
                        <div className="col-12 col-md-8">
                            ...
                            <div className="row my-4">
                                ...
                                <div className="col">
                                    {mydata.Approach ? mydata.Approach.split(',').map((v, i) => {
                                        return <p key={i} className="way mx-1">{v}</p>
                                    }) : ''}
                                </div>
                            </div>
                            <div className="row my-4">
