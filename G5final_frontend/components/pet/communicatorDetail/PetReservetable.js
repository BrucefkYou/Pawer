                ...
                <form id="reserve" onSubmit={submitForm}>
                    ...
                    <div className="d-flex flex-wrap contain justify-content-between container">
                        <div className="col-12 col-lg-5">
                            ...
                            <input id="reservName" className="form-control" type="text" name='ReserveName' required onChange={onChange} />
                        </div>
                        <div className="col-12 col-lg-5">
                            <label className="form-control-label" htmlFor="phone" >
                                聯絡電話<span style={{ color: 'red' }}>*</span>
                            </label>
                            <input id="phone" className="form-control" type="text" name='Phone' required onChange={onChange} />
                        </div>
                        <div className="col-12 col-lg-5">
                            <label className="form-control-label" htmlFor="pet">
                                寵物類型<span style={{ color: 'red' }}>*</span>
                            </label>
                            <select className="form-select" name='PetType' onChange={onChange}>
                                <option>狗</option>
                                <option>貓</option>
                            </select>
                        </div>
                        <div className="col-12 col-lg-5">
                            ...
                            <input id="petname" className="form-control" type="text" name='PetName' required onChange={onChange} />
                        </div>
                        <div className="col-12 col-lg-5">
                            <label className="form-control-label" htmlFor="torun">
                                進行方式<span style={{ color: 'red' }}>*</span>
                            </label>
                            <select className="form-select" name='Approach' onChange={onChange}>
                        ...
                        <div className="col-12 col-lg-5">
                            ...
                            <DatePicker
                                selected={startDate}
                                onChange={(date) => { setStartDate(date); onChange({ target: { name: 'Time', value: moment(startDate).format('YYYY-MM-DD HH:mm:ss') } }) }}
                                showTimeSelect
                                timeFormat="HH:mm:ss"
                                injectTimes={[
